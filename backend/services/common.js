...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.MAIL_ADDRESS, // gmail
...
exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"E-commerce Store" <admin123.maill.send@maill.con>', // sender address
        to,
        subject,
        text,
        html
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="#" target="_blank" style="display: inline-block;">
                <img src="https://seeklogo.com/images/E/elastic-path-logo-006EA6D256-seeklogo.com.png" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
